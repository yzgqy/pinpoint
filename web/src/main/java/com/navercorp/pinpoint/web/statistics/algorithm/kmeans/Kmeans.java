    ...
    public Map<Integer, DijkstraResult> calculateDistance(GraphUtil graphUtil, String[] centerPoints, int k) {
        ...
        for (int i = 0; i < k; i++) {
            ...
            for (DijkstraResult dijkstraResult : dijkstraResults) {
                System.out.println(dijkstraResult.getSourceId()+"*"+dijkstraResult.getSourceData()+"-"+dijkstraResult.getWeigth()+"->"+dijkstraResult.getTargetId()+"*"+dijkstraResult.getTargetData());
