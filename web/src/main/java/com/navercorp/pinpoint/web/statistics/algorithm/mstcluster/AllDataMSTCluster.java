...
////        }
//
//        PartitionInfo partitionInfo = cn.edu.nju.software.algorithm.mstcluster.PartitionInfoFromDB.getPartitionInfoById("190324D9D9ZGSG54");
//        //获取动态边
//        List<GitCommitFileEdge> dEdges = new cn.edu.nju.software.algorithm.mstcluster.InitialEdges().getAllDynamicEdge(partitionInfo);
